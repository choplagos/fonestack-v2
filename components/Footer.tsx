...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-white/5 py-8 pb-24 md:pb-8 bg-transparent print:hidden">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <nav aria-label="Social links" className="flex items-center gap-4">
          {/* Social icons */}
          <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram" className="text-slate-300 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-premiumYellow focus-visible:ring-offset-2 rounded">
          ...
          <a href={SOCIAL_LINKS.snapchat} target="_blank" rel="noopener noreferrer" aria-label="Snapchat" title="Snapchat" className="text-slate-300 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-premiumYellow focus-visible:ring-offset-2 rounded">
